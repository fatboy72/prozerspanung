					...
					<main id="main" class="site-main" role="main">
						...
						<header class="page-header">
							<h1 class="page-title">
								...
								elseif (is_day()) :
									printf(__('Day: %s', 'pnd-bootstrap-basic'), '<span>' . get_the_date() . '</span>');

								elseif (is_month()) :
									printf(__('Month: %s', 'pnd-bootstrap-basic'), '<span>' . get_the_date('F Y') . '</span>');

								elseif (is_year()) :
									printf(__('Year: %s', 'pnd-bootstrap-basic'), '<span>' . get_the_date('Y') . '</span>');
								...
								elseif (is_tax('post_format', 'post-format-link')) :
									_e('Links', 'pnd-bootstrap-basic');

								else :
									_e('Archives', 'pnd-bootstrap-basic');

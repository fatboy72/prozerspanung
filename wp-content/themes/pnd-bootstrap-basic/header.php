                ...
                <div class="container" style="padding-top: 20px;">
					<div class="row row-with-vspace">
                                            <div class="col-xs-4 col-md-6 header-text">
                                                ...
                                                <?php pll_e( 'Datumausgabe' ); echo '&nbsp;'.show_time(); ?><br />
                                                <?php echo wp_nav_menu( array( 'menu' => 'sprachumschaltung', 'menu_class' => 'sprachumschaltung' ) ); ?>
                                            </div>

                                            <div class="col-xs-8 col-md-6 header-logo">
                                                <a href="<?php echo country_switch() ?>" rel="home"><img src="<?php site_url(); ?>wp-content/themes/pnd-bootstrap-basic/img/logo.jpg" alt="logo" class="img-responsive"/></a>
                                            </div>
					</div><!--.row-->
				</div><!--.container-->
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="navbar-header">
                                            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-primary-collapse">
                                                <span class="sr-only"><?php _e('Toggle navigation', 'pnd-bootstrap-basic'); ?></span>
                                        ...
                                        <div class="collapse navbar-collapse navbar-primary-collapse">
                                            ...
                                            <div class="hidden-md hidden-lg"><?php echo wp_nav_menu( array( 'menu' => 'sprachumschaltung' ) ); ?></div>
                ...
                <div class="slogan">
                    <div class="container">
                        <div class="slogan-icon">
                            <img class="img-responsive pull-left" src="wp-content/themes/pnd-bootstrap-basic/img/up-arrow.png" alt="up-arrow"></img>
                        </div>

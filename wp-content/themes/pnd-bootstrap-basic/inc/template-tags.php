...
if (!function_exists('bootstrapBasicMoreLinkText')) {
	...
	{
		$temp_value = pll__( 'weiterlesen' );
		return __( $temp_value .' <span class="meta-nav">&rarr;</span>', 'bootstrap-basic');
...
//		}
		...
		printf(__('<span class="posted-on">' .pll__( 'Post Meta Datum' ) .' %1$s</span>', 'bootstrap-basic'),

...
<form role="search" method="get" class="search-form form" action="<?php echo esc_url(home_url('/')); ?>">
	...
	<div class="input-group">
		<input type="search" id="form-search-input" class="form-control" placeholder="<?php echo esc_attr_x('SUCHEBEGRIFF', 'placeholder', 'bootstrap-basic'); ?>" value="<?php echo esc_attr(get_search_query()); ?>">
